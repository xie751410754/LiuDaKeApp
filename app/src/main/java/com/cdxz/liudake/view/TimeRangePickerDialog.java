...
import com.cdxz.liudake.util.CommonUtils;
...
//        setTimePickerDividerColor(timePickerEnd);
    ...
    private void setEvent() {
        ...
        submitBtn.setOnClickListener(v -> {
            ...
            confirmAction.onRightClick(startTime + " - " + endTime,startTime,endTime);
            dismiss();
        });
    ...
    private void setTimePickerDividerColor(TimePicker timePicker) {
        FrameLayout llFirst = (FrameLayout) timePicker.getChildAt(0);
        FrameLayout mSpinners = (FrameLayout) llFirst.getChildAt(1);
    ...
    public interface ConfirmAction {
        ...
        void onRightClick(String startAndEndTime,String start,String end);
    }
