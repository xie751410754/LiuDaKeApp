...
public class StoreMessageListAdapter extends BaseQuickAdapter<StoreMessageListBean.ListBean, BaseViewHolder> {
    public StoreMessageListAdapter(List<StoreMessageListBean.ListBean> data) {
        super(R.layout.item_message_list, data);
    }

    @Override
    protected void convert(BaseViewHolder baseViewHolder, StoreMessageListBean.ListBean messageListBean) {
