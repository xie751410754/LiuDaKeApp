...
import com.cdxz.liudake.ui.my.service.OpenStoreActivity;
    ...
    protected void initListener() {
        refresh.setOnRefreshListener(refreshLayout ->
                HttpsUtil.getInstance(getContext()).userIndex(object -> {
                    ...
                    tvPhone.setText(indexBean.getPhone().substring(0, 3) + "****" + indexBean.getPhone().substring(7, indexBean.getPhone().length()));
...
//            });
    ...
    @OnClick({R.id.ivSet, R.id.tvInviteCode,
            ...
            R.id.tvOrderAll, R.id.tvOrder1, R.id.tvOrder2, R.id.tvOrder3})
    ...
    private void initMyService() {
        ...
        serviceBean = new ServiceBean(R.mipmap.icon_service_tuiguang, "我的推广");
        serviceBeanList.add(serviceBean);
        serviceBean = new ServiceBean(R.mipmap.icon_service_qianbao, "提现");
        serviceBeanList.add(serviceBean);
        serviceBean = new ServiceBean(R.mipmap.icon_service_kaidian, "开店入驻");
        serviceBeanList.add(serviceBean);

        serviceBean = new ServiceBean(R.mipmap.icon_service_address, "地址管理");
        serviceBeanList.add(serviceBean);
        serviceBean = new ServiceBean(R.mipmap.icon_service_collect, "我的收藏");
        serviceBeanList.add(serviceBean);
        serviceBean = new ServiceBean(R.mipmap.icon_service_kefu, "联系客服");
        serviceBeanList.add(serviceBean);

        serviceBean = new ServiceBean(R.mipmap.icon_service_wenti, "常见问题");
        serviceBeanList.add(serviceBean);

        serviceBean = new ServiceBean(R.mipmap.ic_lookup, "运营中心");
        serviceBeanList.add(serviceBean);

        serviceBean = new ServiceBean(R.mipmap.icon_service_store, "我的店铺");
        serviceBeanList.add(serviceBean);

        serviceBean = new ServiceBean(R.mipmap.icon_shoumi, "收米");
        serviceBeanList.add(serviceBean);
