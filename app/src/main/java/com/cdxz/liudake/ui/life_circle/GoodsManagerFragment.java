...
public class GoodsManagerFragment extends BaseFragment {
    ...
    public static GoodsManagerFragment newInstance(String id ,int status){
        GoodsManagerFragment tuiJianStoreFragment = new GoodsManagerFragment();
    ...
    protected void initData() {
        ...
        storeTuiJianAdapter.isGoodManger(true);
        getStoreList();
    ...
    private void getStoreList() {
        HttpsUtil.getInstance(getContext()).nearShopGoodsList( page, getArguments().getString("id"), getArguments().getInt("status"),object -> {
