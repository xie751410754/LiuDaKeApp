 ...
 * Use the {@link SearchLifeCircleChildFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SearchLifeCircleChildFragment extends BaseFragment {
    ...
    public SearchLifeCircleChildFragment() {
        // Required empty public constructor
    }

    public static SearchLifeCircleChildFragment newInstance(String cat_id) {
        SearchLifeCircleChildFragment fragment = new SearchLifeCircleChildFragment();
    ...
    @BusUtils.Bus(tag = BusTag.KEYWORDS)
    ...
    @BusUtils.Bus(tag = BusTag.GET_SEARCH_STORE_ID)
    public void onGetSearchStoreId(GetStoreIdBean bean) {
