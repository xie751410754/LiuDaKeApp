...
//    private String[] tabTitle = {"推荐", "推荐", "推荐", "推荐", "推荐"};
    ...
    public static void startGoodsListActivity(Context context, String cateid, String name) {
...
//        });
    ...
    private void goodsList() {
        HttpsUtil.getInstance(this).goodsList(page, null, null, getIntent().getStringExtra("cateid"),
