...
public class JDGoodsListActivity extends BaseActivity {
    ...
    public static void starJDGoodsListActivity(Context context,String catID,String categoryName) {
        Intent intent = new Intent(context, JDGoodsListActivity.class);
...
//        layoutMediator.attach();
        ...
        setTitleText(getIntent().getStringExtra("categoryName"));
...
//            goodsList();
    ...
    private void goodsList(String val) {
        String url = "http://liudake.cn/api/pub/get" + "?param=" + "getprolist" + "&pagesize=" + pageSize + "&page=" + page +"&catid="+getIntent().getStringExtra("catID");
